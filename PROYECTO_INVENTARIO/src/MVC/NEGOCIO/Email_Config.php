...
try {
    ...
    $mail->Username = 'prbs.software.matias@gmail.com'; //TU CORREO PARA ENVIAR EMAILS DE REESTABLECIMIENTO DE CONTRASEÑAS AQUI (DE SER UN GMAIL)
    $mail->Password = 'pztblfwlfdismthl'; //TU CONTRASEÑA PARA DE APLICACION AQUI (DE SER DEL GMAIL, RECUERDA ACTIVAR LA AUTENTICACION EN 2 PASOS Y USAR CONTRASEÑA DE APLICACION)
    ...
    $mail->setFrom('prbs.software.matias@gmail.com', 'INVENTARIOS_TEST_VERSION'); //DEFINE EL CORREO Y NOMBRE DEL REMITENTE QUE APARECERA CUANDO SE RESIVA EL CORREO 
