...
try {
    ...
    $mail->Password = 'CONTRASEÑA GMAIL'; //TU CONTRASEÑA PARA DE APLICACION AQUI (DE SER DEL GMAIL, RECUERDA ACTIVAR LA AUTENTICACION EN 2 PASOS Y USAR CONTRASEÑA DE APLICACION)
    ...
    $mail->setFrom('CONTRASEÑA APP GMAIL', 'INVENTARIOS_TEST_VERSION'); //DEFINE EL CORREO Y NOMBRE DEL REMITENTE QUE APARECERA CUANDO SE RESIVA EL CORREO 
